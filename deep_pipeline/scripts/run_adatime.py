    ...
    if use_cnn:
        ...
        if source_cnn_ckpt.exists() and not target_only:
            ...
            frozen_model = train_source_cnn(
                ...
                mid_channels=cnn_cfg.get("mid_channels", 64),
                final_out_channels=cnn_cfg.get("final_out_channels", 128),
                kernel_size=cnn_cfg.get("kernel_size", 5),
                stride=cnn_cfg.get("stride", 1),
                dropout=cnn_cfg.get("dropout", 0.5),
                features_len=cnn_cfg.get("features_len", 1),
